...
Class Admin extends MY_Controller
{
    ...
    function index()
    {
        ...
        $this->data['title']='Quản Trị Thành Viên';
        $this->data['title_page']='Danh Sách Ban Quản Trị';
    ...
    function add()
    {
        ...
        $this->data['title_page']='Đăng Ký Mới Thành Viên Quản Trị';
    ...
    function edit()
    {
        ...
        $this->data['title_page']='Cập Nhật Thành Viên Quản Trị';
