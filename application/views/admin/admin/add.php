      ...
      <form id="form" class="form" enctype="multipart/form-data" method="post" action="">
          <div class="box-body">
                ...
                <div class="form-group">
                	...
                	<div class="col-sm-10">
                		<span class="oneTwo"><input type="text" _autocheck="true" id="param_name" value="<?php echo set_value('name')?>" name="name" class="form-control" style="width:200px"></span>
                 ...
                 <div class="form-group">
                	...
                	<div class="col-sm-10">
                		<span class="oneTwo"><input type="text" _autocheck="true" value="<?php echo set_value('username')?>" id="param_username" name="username" class="form-control" style="width:200px"></span>
                		<span class="autocheck" name="name_autocheck"></span>
                 ...
                 <div class="form-group">
                	...
                	<div class="col-sm-10">
                		<span class="oneTwo"><input type="password" _autocheck="true" id="param_password" name="password" class="form-control" style="width:200px"></span>
                		<span class="autocheck" name="name_autocheck"></span>
                 ...
                 <div class="form-group">
                	...
                	<div class="col-sm-10">
                		<span class="oneTwo"><input type="password" _autocheck="true" id="param_re_password" name="re_password" class="form-control" style="width:200px"></span>
                		<span class="autocheck" name="name_autocheck"></span>
