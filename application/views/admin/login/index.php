...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p style="color:red;font-weight:blod;text-align:center"></p>

    <form  method="post">
      <div class="form-group has-feedback">
        <input type="text" id="param_username" name="user" class="form-control" placeholder="Email">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" id="param_password" name="pass" class="form-control" placeholder="Password">
