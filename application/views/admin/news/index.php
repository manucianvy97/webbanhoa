...
<div id="main_product" class="box-body">
	<div class="col-md-2 form-group pull-left">
		<a href="<?php echo admin_url('news/add')?>" class="btn btn-block btn-success"><span class="glyphicon glyphicon-plus"></span> Thêm mới</a>
	</div>
	<div class="col-md-2 form-group pull-right">
		...
		<table width="100%" cellspacing="0" cellpadding="0" id="checkAll" class="table table-bordered table-striped dataTable">
